...
exports.getForvaltare = (req, res, next) => {
	res.status(200).json({
		success: true,
		msg: 'Visa alla fastighetsförvaltare',
	});
};
...
exports.getEnForvaltare = (req, res, next) => {
	res.status(200).json({
		success: true,
		msg: `Visa fastighetsförvaltare ${req.params.id}`,
	});
};
...
exports.createForvaltare = (req, res, next) => {
	res.status(200).json({
		success: true,
		msg: 'Skapa en ny fastighetsförvaltare',
	});
};
...
exports.updateForvaltare = (req, res, next) => {
	res.status(200).json({
		success: true,
		msg: `Uppdatera fastighetsförvaltare ${req.params.id}`,
	});
};
...
exports.deleteForvaltare = (req, res, next) => {
	res.status(200).json({
		success: true,
		msg: `Ta bort fastighetsförvaltare ${req.params.id}`,
	});
};
